<template>
  <v-container fluid class="pt-12 ma-0">
    <Navigation/>
    <v-row class="pa-0 ml-12 mt-12 mb-12 universities-background-image">
        ...
        >
          <v-col md="12">
            <v-card
                ...
                elevation="0"
            >
              <v-card-title class="universities-title">{{ universities.title }}</v-card-title>
              <v-card-text class="universities-text" v-html="universities.text">
              </v-card-text>
              <v-card-actions>
                <v-btn
                    outlined
                    ...
                    class="tip-button"
                    target="_blank"
                    :href="universities.buttonLink"
                    v-if="universities.buttonText !== ''"
                >
                  {{ universities.buttonText }} <v-icon>mdi-chevron-right</v-icon>
                </v-btn>
              </v-card-actions>
            </v-card>
          </v-col>
