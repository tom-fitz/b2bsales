<template>
  <v-container fluid class="pt-12 ma-0">
    <Navigation/>
    <v-row class="pa-0 ml-12 mt-12 mb-12 officeHours-background-image">
        ...
        >
          <v-col md="12">
            <v-card
                ...
                elevation="0"
            >
              <v-card-title class="officeHours-title">{{ officeHours.title }}</v-card-title>
              <v-card-text class="officeHours-text" v-html="officeHours.text">
              </v-card-text>
              <v-card-actions>
                <v-btn
                    outlined
                    ...
                    class="tip-button"
                    target="_blank"
                    :href="officeHours.buttonLink"
                    v-if="officeHours.buttonText !== ''"
                >
                  {{ officeHours.buttonText }} <v-icon>mdi-chevron-right</v-icon>
                </v-btn>
              </v-card-actions>
            </v-card>
          </v-col>
