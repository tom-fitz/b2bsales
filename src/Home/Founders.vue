<template>
  <v-container fluid class="pt-12 ma-0">
    <Navigation/>
    <v-row class="pa-0 ml-12 mt-12 mb-12 founders-background-image">
        ...
        >
          <v-col md="12">
            <v-card
                ...
                elevation="0"
            >
              <v-card-title class="founders-title">{{ founders.title }}</v-card-title>
              <v-card-text class="founders-text" v-html="founders.text">
              </v-card-text>
              <v-card-actions>
                <v-btn
                    outlined
                    ...
                    class="tip-button"
                    target="_blank"
                    :href="founders.buttonLink"
                >
                  {{ founders.buttonText }} <v-icon>mdi-chevron-right</v-icon>
                </v-btn>
              </v-card-actions>
            </v-card>
          </v-col>
